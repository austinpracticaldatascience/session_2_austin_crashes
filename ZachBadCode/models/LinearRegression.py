...
see: https://github.com/aladdinpersson/Machine-Learning-Collection/blob/master/ML/algorithms/linearregression/linear_regression_gradient_descent.py
"""
...
if __name__ == "__main__":
    X = np.random.rand(100, 542)
    y = 3 * X + 5 + np.random.randn(100, 542) * 0.1
